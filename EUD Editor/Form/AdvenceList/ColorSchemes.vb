Public Class ColorSchemes
    ...
    Public Shared SelectedNormal As Color() = New Color() {Color.FromArgb(103, 153, 255), Color.FromArgb(103, 153, 255), Color.FromArgb(103, 153, 255), Color.FromArgb(103, 153, 255), Color.FromArgb(103, 153, 255)}

    Public Shared SelectedHover As Color() = New Color() {Color.FromArgb(103, 163, 255), Color.FromArgb(103, 163, 255), Color.FromArgb(103, 163, 255), Color.FromArgb(103, 163, 255), Color.FromArgb(103, 163, 255)}

    Public Shared SelectedPressed As Color() = New Color() {Color.FromArgb(83, 133, 235), Color.FromArgb(83, 133, 235), Color.FromArgb(83, 133, 235), Color.FromArgb(83, 133, 235), Color.FromArgb(83, 133, 235)}

    '  Public Shared SelectedBorder = New SolidBrush(Color.FromArgb(194, 138, 48))
    Public Shared SelectedBorder = New SolidBrush(Color.FromArgb(71, 200, 62))
